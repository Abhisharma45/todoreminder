...
import ve.com.msd.todo.app.dialogs.SelectImageSourceDialogFragment;
import ve.com.msd.todo.enums.ImageSourceType;
import ve.com.msd.todo.enums.TapTargetSequenceType;
import ve.com.msd.todo.model.attachment.ImageAttachment;
import ve.com.msd.todo.util.FileUtil;
import ve.com.msd.todo.util.ImageUtil;
import ve.com.msd.todo.util.PermissionUtil;
import ve.com.msd.todo.util.SnackbarUtil;
import ve.com.msd.todo.util.TapTargetSequenceUtil;
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.activity_edit_image_attachment_crop:
                applyPendingRotation();
                File imageFile = new File(FileUtil.getImageAttachmentDir(this), mImageAttachment.getImageFilename());
                Uri imageUri = FileProvider.getUriForFile(this, "ve.com.msd.todo.fileprovider", imageFile);
    ...
    private void dispatchTakePictureIntent() {
        ...
        if (takePictureIntent.resolveActivity(this.getPackageManager()) != null) {
            ...
            if(imageAttachmentFile != null) {
                try {
                    imageUri = FileProvider.getUriForFile(this, "ve.com.msd.todo.fileprovider", imageAttachmentFile);
